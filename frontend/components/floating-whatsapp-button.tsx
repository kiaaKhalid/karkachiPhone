...
export function FloatingWhatsAppButton() {
  ...
  const isBottomBarPage = 
    (pathname === "/wishlist" && wishlist.length > 0) || 
    (pathname === "/cart" && totalItems > 0)

  return (
    <div className={`fixed ${isBottomBarPage ? "bottom-36" : "bottom-20"} right-4 md:bottom-6 md:right-6 z-50 transition-all duration-300`}>
      <Button
